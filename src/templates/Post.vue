        ...
        >
          <div>
            <g-link
              ...
              :key="tag.id"
              :to="`${tag.path}/`"
              class="inline-block text-teal-400 hover:text-blue-400 hover:bg-teal-400 border border-teal-400 font-sans font-bold text-xs sm:text-sm px-4 py-2 mr-4 mb-2 rounded-full transition-color transition-bg"
            >
              <svg
            ...
            <div class="px-4 sm:w-4/5 text-center sm:text-left">
              <h4 class="font-sans font-bold text-lg sm:text-xl mb-2 sm:mb-4">
                <g-link
                  ...
                  class="text-black hover:text-blue-400 capitalize border-b-2 border-transparent transition-color"
